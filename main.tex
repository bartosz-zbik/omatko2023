...
\pause
Niech $R:\Omega \to \Time$ (czas po jakim resetujemy), będzie niezależne od $(X_t)_{t \in \Time}$.
\pause
\begin{block}{Definicja}
Zdefiniujmy\footnotemark{} $(X^*_t)_{t \in \Time}$ ("proces resetowany") jako
\begin{equation}
X^*_t = \begin{cases}
X_t &,~\text{gdy}~ t < R \\
Y_{t-R}^* &,~\text{gdy}~ t \ge R~,
\end{cases}
\end{equation}
gdzie $(Y_t^*)_{t \in \Time}$ jest niezależną kopią procesu resetowanego $(X_t^*)_{t \in \Time}$.
\end{block}
...
\bibitem{pal2017first}A. Pal and S. Reuveni, Phys. Rev. Lett. 118, 030603 (2017)
\bibitem{chechkin2018random}A. Chechkin and I. M. Sokolov Phys. Rev. Lett. 121, 050601 (2018)
\bibitem{pal2019first}Arnab Pal and V. V. Prasad Phys. Rev. E 99, 032123 (2019)
\bibitem{getoor1961}R. K. Getoor, Trans. Am. Math. Soc. 101, 75 (1961)
\end{thebibliography}
\end{frame}
